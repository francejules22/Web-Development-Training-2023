<script>
    ...
    if(localStorage.getItem('todos') == null){
        localStorage.setItem('todos', JSON.stringify([
          {
              name: 'Design UI and UX in Figma',
              completed: true,
              id: 0
          },
          {
              name: 'Integrate Design using HTML and CSS',
              completed: false,
              id: 1
          },
          {
              name: 'Code using Javascript and other frameworks',
              completed: false,
              id: 2
          },
          {
              name: 'Make Repositories using Git and Github',
              completed: false,
              id: 3
          },
          {
              name: 'Host website using any hosting platform',
              completed: false,
              id: 4
          },
          {
              name: 'Upload website in any devices',
              completed: false,
              id: 5
          }
      ]));
     ...
     //variables
     let newTodo;
     $: itemsLeft = todos.filter((todo) => !todo.completed).lenght;
     let filter = 'all';
     ...
     function addTodo(){
         if(newTodo){
             ...
             //add todo to todos....
             todos = [...todos, {name: mewTodo, complete: false, id: newID}];
             newTodo = '';
             console.log(todos);
         }
     }
     ...
     //add 'press' 'enter' to add nw todo functionality....
